  ...
  <section className="services-section">
    ...
    <div className="services-section__center">
      ...
      <div className="services-section__buttons">
        ...
        <Link href="/bodas" className="eterea-button" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>BODAS</Link>
        <Link href="/vip-assistance" className="eterea-button" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>VIP ASSISTANCE</Link>
      </div>
    </div>
